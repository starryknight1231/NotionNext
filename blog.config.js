...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '35ca1733d6da4eeab47f28d44af1d3e1',
  ...
  GREETING_WORDS:
    ...
    'Hi，我是一个程序员, Hi，我是一个民航人,Hi，我是一个民航搬砖人,欢迎来到我的博客🎉',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'starryknight1031', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通的民航搬砖人🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://blog.starryknight.top', // 网站地址
